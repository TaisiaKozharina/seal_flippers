...
| Zeyao Yan | | | |
| Zihao Yang | | | |
| Deborah |Analyzed  dataset folders sent by NRM and documented image counts, naming inconsistencies, and quality issues per folder, published to github | 7 | :white_check_mark: |
| Deborah | Rewrote the requirement specification (user requirements, functional/non-functional requirements, priority table) | 4 | :white_check_mark: |
...
| Taisija | Created GitHub repository for code and documentation storage, added description and tracking file. Added permissions for group members | 4 | :white_check_mark: |
| Taisija | Reviewed, summarized and published meeting notes | 3 | :white_check_mark: |
